...
{
	public class GapDownPercent : MarketAnalyzerColumn
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Name					= NinjaTrader.Custom.Resource.NinjaScriptMarketAnalyzerColumnNameGapDownPercent;
				Description				= NinjaTrader.Custom.Resource.NinjaScriptMarketAnalyzerColumnDescriptionGapDownPercent;
		...
		{
			( > 0, > 0)		=> (sessionHigh - priorLow) / priorLow,
			_				=> double.MinValue
		};
	...
	public override string Format(double value)
		{
			return value == double.MinValue ? string.Empty : value.ToString("P", Core.Globals.GeneralOptions.CurrentCulture); //Instrument.MasterInstrument.FormatPrice(value);
		}
		#endregion
	}
}
