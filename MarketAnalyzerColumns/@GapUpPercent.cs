...
{
	public class GapUpPercent : MarketAnalyzerColumn
	{
		...
		protected override void OnStateChange()
		{
			...
			{
				Name					= NinjaTrader.Custom.Resource.NinjaScriptMarketAnalyzerColumnNameGapUpPercent;
				Description				= NinjaTrader.Custom.Resource.NinjaScriptMarketAnalyzerColumnDescriptionGapUpPercent;
		...
		{
			( > 0, > 0)		=> (sessionLow - priorHigh) / priorHigh,
			_				=> double.MinValue
		};
