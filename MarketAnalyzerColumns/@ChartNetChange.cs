...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	public class ChartNetChange : Gui.NinjaScript.MarketAnalyzerColumnRenderBase
	{
		...
		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				...
				DownArea				= new SolidColorBrush((Color)ColorConverter.ConvertFromString("#50FF0000"));
				DownOutline				= Core.Globals.GeneralOptions.BrushDownPrimary;
				IsDataSeriesRequired	= true;
				UpArea					= new SolidColorBrush((Color)ColorConverter.ConvertFromString("#5032CD32")); 
		...
		public override void OnRender(DrawingContext dc, System.Windows.Size renderSize)
		{
			...
			if (downAreaBrush == null)
				downAreaBrush = downArea.Clone() as SolidColorBrush;
			if (upAreaBrush == null)
				upAreaBrush = upArea.Clone() as SolidColorBrush;
	...
	public class ChartNetChangeConverter : NinjaTrader.NinjaScript.IndicatorBaseConverter
	{
		...
		public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object component, Attribute[] attrs)
		{
			...
			if (component is not ChartNetChange || propertyDescriptorCollection == null)
