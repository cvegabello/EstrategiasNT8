...
namespace NinjaTrader.NinjaScript.DrawingTools
{
	...
	public abstract class RegionHighlightBase : DrawingTool
	{
		...
		public override Point[] GetSelectionPoints(ChartControl chartControl, ChartScale chartScale)
		{
			...
			double		middleX		= chartPanel.X + chartPanel.W / 2.0;
			double		middleY		= chartPanel.Y + chartPanel.H / 2.0;
			Point		midPoint	= new((startPoint.X + endPoint.X) / 2, (startPoint.Y + endPoint.Y) / 2);
			return new[] { startPoint, midPoint, endPoint }.Select(p => Mode == RegionHighlightMode.Time ? new Point(p.X, middleY) : new(middleX, p.Y)).ToArray();
		}
	...
	{
		public override object Icon => Gui.Tools.Icons.DrawRegionHighlightX;
	...
	{
		public override object Icon => Gui.Tools.Icons.DrawRegionHighlightY;
	...
	public static partial class Draw
	{
			...
			Brush brush, Brush areaBrush, int areaOpacity, bool isGlobal, string templateName) where T : RegionHighlightBase
		{
			...
			if (DrawingTool.GetByTagOrNew(owner, typeof(T), tag, templateName) is not T regionHighlight)
				return null;
		...
		public static RegionHighlightX RegionHighlightX(NinjaScriptBase owner, string tag, DateTime startTime, DateTime endTime, Brush brush)
			=> RegionHighlightCore<RegionHighlightX>(owner, tag, false, int.MinValue, startTime, 0, int.MinValue, endTime, 0, brush, defaultRegionBrush, defaultRegionOpacity, false, null);
		...
		public static RegionHighlightX RegionHighlightX(NinjaScriptBase owner, string tag, int startBarsAgo, int endBarsAgo, Brush brush) =>
			RegionHighlightCore<RegionHighlightX>(owner, tag, false, startBarsAgo, Core.Globals.MinDate, 0, endBarsAgo, Core.Globals.MinDate, 0, brush, defaultRegionBrush, defaultRegionOpacity, false, null);
		...
		public static RegionHighlightX RegionHighlightX(NinjaScriptBase owner, string tag, DateTime startTime, DateTime endTime, Brush brush, Brush areaBrush, int areaOpacity)
			=> RegionHighlightCore<RegionHighlightX>(owner, tag, false, int.MinValue, startTime, 0, int.MinValue, endTime, 0, brush, areaBrush, areaOpacity, false, null);
		...
		public static RegionHighlightX RegionHighlightX(NinjaScriptBase owner, string tag, int startBarsAgo, int endBarsAgo, Brush brush, Brush areaBrush, int areaOpacity)
			=> RegionHighlightCore<RegionHighlightX>(owner, tag, false, startBarsAgo, Core.Globals.MinDate, 0, endBarsAgo, Core.Globals.MinDate, 0, brush, areaBrush, areaOpacity, false, null);
		...
		public static RegionHighlightX RegionHighlightX(NinjaScriptBase owner, string tag, DateTime startTime, DateTime endTime, bool isGlobal, string templateName)
			=> RegionHighlightCore<RegionHighlightX>(owner, tag, false, int.MinValue, startTime, 0, int.MinValue, endTime, 0, null, null, -1, isGlobal, templateName);
		...
		public static RegionHighlightX RegionHighlightX(NinjaScriptBase owner, string tag, int startBarsAgo, int endBarsAgo, bool isGlobal, string templateName)
			=> RegionHighlightCore<RegionHighlightX>(owner, tag, false, startBarsAgo, Core.Globals.MinDate, 0, endBarsAgo, Core.Globals.MinDate, 0, null, null, -1, isGlobal, templateName);
		...
		public static RegionHighlightY RegionHighlightY(NinjaScriptBase owner, string tag, double startY, double endY, Brush brush)
			=> RegionHighlightCore<RegionHighlightY>(owner, tag, false, 0, Core.Globals.MinDate, startY, 0, Core.Globals.MinDate, endY, brush, defaultRegionBrush, defaultRegionOpacity, false, null);
		...
		public static RegionHighlightY RegionHighlightY(NinjaScriptBase owner, string tag, bool isAutoScale, double startY, double endY, Brush brush, Brush areaBrush, int areaOpacity)
			=> RegionHighlightCore<RegionHighlightY>(owner, tag, isAutoScale, 0, Core.Globals.MinDate, startY, 0, Core.Globals.MinDate, endY, brush, areaBrush, areaOpacity, false, null);
		...
		public static RegionHighlightY RegionHighlightY(NinjaScriptBase owner, string tag, double startY, double endY, bool isGlobal, string templateName)
			=> RegionHighlightCore<RegionHighlightY>(owner, tag, false, 0, Core.Globals.MinDate, startY, 0, Core.Globals.MinDate, endY, null, null, -1, isGlobal, templateName);
	}
}
